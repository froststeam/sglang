...
- **No extra model available**: Use **NGRAM** (`--speculative-algorithm NGRAM`, CUDA and MUSA).
...
<tr>
      ...
      <td style={{padding: "9px 12px", backgroundColor: "rgba(255,255,255,0.05)"}}>CUDA and MUSA; no <code>--enable-dp-attention</code>; disables overlap scheduler &amp; mixed chunked prefill</td>
    </tr>
</tbody>
</table>
...
Notes:
- Ngram speculative decoding supports CUDA and MUSA.
