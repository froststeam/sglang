...
GPU_TAG="${GPU_TAG:-ph1}"
CPU_ARCH_TAG_PART="${CPU_ARCH_TAG_PART:-}"
MUSA_VERSION="${MUSA_VERSION:-4.3.5}"
TORCH_VERSION="${TORCH_VERSION:-2.9.0}"
SGLANG_NIGHTLY_CHANNEL_TAG="${SGLANG_NIGHTLY_CHANNEL_TAG:-${SGLANG_VERSION}-${GPU_TAG}${CPU_ARCH_TAG_PART}-${MUSA_VERSION}-torch${TORCH_VERSION}-latest}"
SGLANG_NIGHTLY_FALLBACK_IMAGE="${SGLANG_NIGHTLY_FALLBACK_IMAGE:-${SGLANG_NIGHTLY_IMAGE_REPO}:${SGLANG_NIGHTLY_CHANNEL_TAG}}"
