...
class Envs:
    ...
    SGLANG_USE_JIT_ALL_REDUCE = EnvBool(False)
    ...
    # Opt in: this path uses single-node IPC and a fixed per-rank output buffer.
    SGLANG_MUSA_USE_JIT_ALL_TO_ALL = EnvBool(False)
