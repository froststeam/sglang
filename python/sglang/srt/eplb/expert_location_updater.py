...
class ExpertLocationUpdater:
    ...
    def update(
        ...
        missing_logical_experts_by_layers = yield from _update_expert_weights(
        ...
        return missing_logical_experts_by_layers or {}


def _update_expert_weights(**kwargs):
    if get_bool_env_var("SGLANG_EXPERT_LOCATION_UPDATER_CANARY"):
        return (yield from _update_expert_weights_with_canary(**kwargs))
    else:
        return (yield from _update_expert_weights_raw(**kwargs))
...
def _update_expert_weights_with_canary(
    ...
    missing_logical_experts_by_layers = yield from _update_expert_weights_raw(
        routed_experts_weights_of_layer=routed_experts_weights_of_layer,
        old_expert_location_metadata=old_expert_location_metadata,
        new_expert_location_metadata=new_expert_location_metadata,
        update_layer_ids=update_layer_ids,
