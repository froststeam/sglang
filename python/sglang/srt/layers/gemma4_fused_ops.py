...
def gemma_qkv_rmsnorm(
    ...
    """
    assert q.is_cuda or (_is_musa and q.device.type == "musa")
    ...
    if has_kv:
        assert (k.is_cuda or (_is_musa and k.device.type == "musa")) and (
            v.is_cuda or (_is_musa and v.device.type == "musa")
        )
